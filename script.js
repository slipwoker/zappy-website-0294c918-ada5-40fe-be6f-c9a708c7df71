  ...
  if (contactForm) {
    ...
    function getErrorMessage(field) {
      ...
      if (validity.patternMismatch) {
        return field.dataset.errorPattern || errorMessages.patternMismatch;
      }
      return field.dataset.errorDefault || errorMessages.default;
    }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      successMsg.textContent = contactForm.dataset.successMessage || 'Your message has been sent successfully!';
    });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "לורן משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0294c918-ada5-40fe-be6f-c9a708c7df71',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0294c918-ada5-40fe-be6f-c9a708c7df71';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0294c918-ada5-40fe-be6f-c9a708c7df71';
